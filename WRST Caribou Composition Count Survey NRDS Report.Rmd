...
ggplot() + geom_sf(data = AKParksShp) + geom_density_2d(data = CCDF, aes(x = Longitude, y = Latitude), colour = "red", alpha = 0.9) +
...
# Exclude raw data - provisional or certified only
Sql = paste("SELECT        Year, [Survey type], GroupSize_Mean AS [Mean group size], [Pct. calf], [Pct. cow], [Pct. bull (composition survey)] AS [Pct. bull], [Calves/100 cows], [Bulls/100 cows], [Total groups observed] AS n, [Pct. small bull], 
