...
These data were compiled by the National Park Service Biological Resources Division and are available at <https://doi.org/10.57830/12342567> (see Table 1). Table 1: Data Package Title: List of data files

| File Name                | Size | Description                                                                         |
|--------------------------|------|-------------------------------------------------------------------------------------|
| CensusSurveys.csv        | 0 Mb | Population and composition surveys data for the Chisana and Mentasta Caribou Herds. |
| RadiotrackingSurveys.csv | 0 Mb | Radiotracking surveys data for the Chisana and Mentasta Caribou Herds.              |
| Movement.csv             | 0 Mb | Movement data from GPS collars for the Chisana and Mentasta Caribou Herds.          |
